...
import { getPermissionOptions } from '@/_actions/permission.action';
...
export default function AddRolePermissionModel({ isOpen, close, role }: AddRolePermissionModelProps) {
    ...
    const { data, isLoading } = useSWRImmutable({ flag: 'getAllPermissions', roleId: role?.id }, getPermissionOptions, {
